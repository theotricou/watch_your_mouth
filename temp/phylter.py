...
if __name__ == "__main__":
    ...
    parser.add_argument('-k2', help='''Same as k for complete gene outlier detection. To preserve complete genes from being discarded, k2 can be increased . By default, k2 = k. (see above)''', default=3, type=float, dest='k2')
